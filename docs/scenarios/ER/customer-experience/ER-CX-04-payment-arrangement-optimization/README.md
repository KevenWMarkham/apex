# Payment-arrangement optimization

**Practice:** ER — Energy & Resources  
**Catalog index:** 061 (compact)  
**Service code:** `ER-PU-04`  
**Headline KPI:** ↑ +18% arrears recovery

## Description
Payment-plan personalization with arrears-reduction targeting.
