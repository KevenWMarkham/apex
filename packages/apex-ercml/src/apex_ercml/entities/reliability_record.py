"""ERCML ReliabilityRecord entity — Pattern C over ISO 14224 reliability data."""
...
class ReliabilityRecord(CanonicalEntity):
    """An ISO 14224 reliability / maintenance event on an ER asset."""

    equipment_key: str = Field(..., description="FK → ERCML Asset.entity_id.")
