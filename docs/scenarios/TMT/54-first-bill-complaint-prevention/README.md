# First-bill-complaint prevention

**Practice:** TMT — Technology, Media, Telecom  
**Catalog index:** 054 (compact)  
**Service code:** `TMT-TEL-CC-03`  
**Headline KPI:** ↓ −42% first-bill calls

## Description
First-bill review for confusing items and proactive outreach.
