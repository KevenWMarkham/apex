# Warranty-claim-pattern → recall risk

**Practice:** AXLE — Automotive & Manufacturing  
**Catalog index:** 102 (compact)  
**Service code:** `AXLE-QMS-02`  
**Headline KPI:** ↑ +24% earlier recall signal

## Description
Warranty-pattern detection for early recall-risk signal.
