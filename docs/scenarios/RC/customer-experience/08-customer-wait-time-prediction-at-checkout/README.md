# Customer-wait-time prediction at checkout

**Practice:** RC — Retail & Consumer  
**Catalog index:** 026 (compact)  
**Service code:** `RC-E2E-05`  
**Headline KPI:** ↓ −41% wait time

## Description
Open-register decisioning based on queue-length prediction 15 minutes ahead.
