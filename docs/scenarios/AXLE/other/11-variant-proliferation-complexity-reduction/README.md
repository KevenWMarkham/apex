# Variant-proliferation-complexity reduction

**Practice:** AXLE — Automotive & Manufacturing  
**Catalog index:** 097 (compact)  
**Service code:** `AXLE-Ops-03`  
**Headline KPI:** · −$4.2M complexity cost

## Description
Variant-complexity analysis with rationalization roadmap.
