# Offshore-wind-maintenance routing

**Practice:** ER — Energy & Resources  
**Catalog index:** 058 (compact)  
**Service code:** `ER-PU-04`  
**Headline KPI:** ↑ +18% maintenance windows

## Description
Weather-aware vessel and technician routing for offshore wind.
