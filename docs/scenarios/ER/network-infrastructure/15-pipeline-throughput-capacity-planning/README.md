# Pipeline-throughput capacity planning

**Practice:** ER — Energy & Resources  
**Catalog index:** 066 (compact)  
**Service code:** `ER-OG-07`  
**Headline KPI:** ↑ +8% throughput capacity

## Description
Network-capacity planning with nomination and flow-constraint modeling.
