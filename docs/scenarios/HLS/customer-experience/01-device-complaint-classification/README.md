# Device-complaint classification

**Practice:** HLS — Health, Life Sciences  
**Catalog index:** 034 (compact)  
**Service code:** `HLS-LS-03`  
**Headline KPI:** ↓ −58% classification time

## Description
Complaint narrative classification and malfunction categorization.
