# Surgical case-type classification

**Practice:** HLS — Health, Life Sciences  
**Catalog index:** 099 (compact)  
**Service code:** `HLS-E2E-02`  
**Headline KPI:** ↑ +14% OR prep accuracy

## Description
Automated case-type classification for coding and equipment prep.
