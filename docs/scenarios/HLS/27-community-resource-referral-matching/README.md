# Community-resource referral matching

**Practice:** HLS — Health, Life Sciences  
**Catalog index:** 027 (compact)  
**Service code:** `HLS-E2E-06`  
**Headline KPI:** ↑ +22% referral completion

## Description
SDOH needs-to-community-resource matching with closed-loop referral.
