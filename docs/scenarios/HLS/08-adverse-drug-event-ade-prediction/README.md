# Adverse drug event (ADE) prediction

**Practice:** HLS — Health, Life Sciences  
**Catalog index:** 008 (compact)  
**Service code:** `HLS-E2E-02`  
**Headline KPI:** ↓ −37% ADEs

## Description
Predictive model flagging medication combinations and patient-context ADE risk.
