# Loyalty-tier-migration prediction

**Practice:** RC — Retail & Consumer  
**Catalog index:** 052 (compact)  
**Service code:** `RC-E2E-04`  
**Headline KPI:** ↑ +9pp tier retention

## Description
Forecasts customer movement up/down tiers to inform proactive nudges.
