# Customer-use-pattern feedback to engineering

**Practice:** ICE — Industrial, Construction, Equipment  
**Catalog index:** 023 (compact)  
**Service code:** `ICE-Connected-06`  
**Headline KPI:** ↑ +22% design improvements

## Description
Usage-pattern feedback to product engineering.
