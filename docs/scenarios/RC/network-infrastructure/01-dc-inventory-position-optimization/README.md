# DC-inventory-position optimization

**Practice:** RC — Retail & Consumer  
**Catalog index:** 027 (compact)  
**Service code:** `RC-E2E-06`  
**Headline KPI:** ↓ −12% safety stock

## Description
Network-level inventory rebalance across DCs and forward stocking locations.
