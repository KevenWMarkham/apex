# 5G-slice-performance monitoring

**Practice:** TMT — Technology, Media, Telecom  
**Catalog index:** 006 (compact)  
**Service code:** `TMT-TEL-NET-02`  
**Headline KPI:** ↑ +14pp SLA adherence

## Description
Network-slice SLA monitoring across enterprise 5G customers.
