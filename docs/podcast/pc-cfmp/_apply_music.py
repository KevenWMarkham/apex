"""
Apply the opening and closing music stings to every CFMP episode MP3.
...
EPISODES = [
    "01-sarahs-day.mp3",
    "02-agent-fleet-and-audit-chain.mp3",
    "03-mobile-scan-and-lot.mp3",
    "04-mobile-trips-replenish-home.mp3",
    "05-portal-operator-console-multitenant.mp3",
    "06-sonos-ambient-voice-channel.mp3",
