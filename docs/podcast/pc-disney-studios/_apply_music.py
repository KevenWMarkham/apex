"""
Apply the opening and closing music stings to every Disney Studios episode MP3.
...
Usage:
    python _apply_music.py        # apply to all 5 episodes in audio/
"""
