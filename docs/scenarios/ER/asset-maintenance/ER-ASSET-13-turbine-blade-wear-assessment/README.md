# Turbine-blade-wear assessment

**Practice:** ER — Energy & Resources  
**Catalog index:** 091 (compact)  
**Service code:** `ER-PU-04`  
**Headline KPI:** ↑ +22% inspection efficiency

## Description
Turbine-condition monitoring for inspection-window optimization.
