# Cold-chain excursion mid-shift

**Practice:** RC — Retail & Consumer  
**Catalog index:** 017 (compact)  
**Service code:** `RC-E2E-03`  
**Headline KPI:** ↓ −18% shrink

## Description
Refrigerated case exceeds temp threshold; operator must decide sell-through, mark down, or destroy.
