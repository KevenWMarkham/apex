# Grocery-produce waste prediction

**Practice:** RC — Retail & Consumer  
**Catalog index:** 042 (compact)  
**Service code:** `RC-E2E-09`  
**Headline KPI:** ↓ −34% produce waste

## Description
Shrink forecast per SKU per store with proactive markdown or donation playbooks.
