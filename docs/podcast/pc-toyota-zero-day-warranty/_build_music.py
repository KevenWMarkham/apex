...
sine-wave additive synthesis. Industrial G-major register, identical to the
DTNA Account Podcast — automotive-brand-family consistency across the APEX
automotive podcasts. Heavy-duty, grounded, manufacturing-floor feel that
sits naturally with TPS / Jidoka / Andon vocabulary of the Toyota episodes.
...
more grounded* — to suit the automotive-industrial brand register Toyota
inherits from DTNA via the automotive-family consistency rule.
