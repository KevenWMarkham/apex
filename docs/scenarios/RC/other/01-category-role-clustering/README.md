# Category role-clustering

**Practice:** RC — Retail & Consumer  
**Catalog index:** 014 (compact)  
**Service code:** `RC-E2E-04`  
**Headline KPI:** ↑ +3pp category share

## Description
Traffic-builder vs destination-category classification per store archetype.
