# Product-marketing briefing auto-generation

**Practice:** TMT — Technology, Media, Telecom  
**Catalog index:** 079 (compact)  
**Service code:** `TMT-TEC-04`  
**Headline KPI:** ↓ −62% brief-prep time

## Description
Automated briefing generation for releases and campaigns.
