# Self-checkout shrink detection

**Practice:** RC — Retail & Consumer  
**Catalog index:** 083 (compact)  
**Service code:** `RC-E2E-07`  
**Headline KPI:** ↓ −48% SCO shrink

## Description
Computer-vision validation of SKU-to-scan mismatch at SCO lanes.
