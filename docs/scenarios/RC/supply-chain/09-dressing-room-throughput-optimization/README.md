# Dressing-room throughput optimization

**Practice:** RC — Retail & Consumer  
**Catalog index:** 031 (compact)  
**Service code:** `RC-E2E-05`  
**Headline KPI:** ↑ +12% conversion

## Description
Staff allocation based on fitting-room occupancy and conversion signals.
