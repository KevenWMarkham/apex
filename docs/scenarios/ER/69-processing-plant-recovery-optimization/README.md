# Processing-plant recovery optimization

**Practice:** ER — Energy & Resources  
**Catalog index:** 069 (compact)  
**Service code:** `ER-MN-02`  
**Headline KPI:** ↑ +2.8pp recovery

## Description
Recovery-circuit optimization across comminution, flotation, and dewatering.
