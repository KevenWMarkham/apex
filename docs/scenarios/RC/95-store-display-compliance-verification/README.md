# Store-display-compliance verification

**Practice:** RC — Retail & Consumer  
**Catalog index:** 095 (compact)  
**Service code:** `RC-E2E-05`  
**Headline KPI:** ↑ +18pp execution

## Description
End-cap, feature, and planogram compliance via store-walk computer vision.
