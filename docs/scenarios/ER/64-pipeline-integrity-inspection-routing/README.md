# Pipeline-integrity inspection routing

**Practice:** ER — Energy & Resources  
**Catalog index:** 064 (compact)  
**Service code:** `ER-OG-07`  
**Headline KPI:** ↑ +28% risk-adjusted coverage

## Description
Risk-based inline-inspection routing and prioritization.
