# Condition-based-maintenance calibration

**Practice:** AXLE — Automotive & Manufacturing  
**Catalog index:** 020 (compact)  
**Service code:** `AXLE-Connected-Factory-01`  
**Headline KPI:** ↑ +14% predictive accuracy

## Description
CBM threshold calibration from historical failure signatures.
