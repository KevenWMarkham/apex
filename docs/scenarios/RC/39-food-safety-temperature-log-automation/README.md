# Food-safety temperature-log automation

**Practice:** RC — Retail & Consumer  
**Catalog index:** 039 (compact)  
**Service code:** `RC-E2E-05`  
**Headline KPI:** ↑ 100% audit trail

## Description
Continuous temp monitoring for regulatory compliance; exception-based HACCP logging.
