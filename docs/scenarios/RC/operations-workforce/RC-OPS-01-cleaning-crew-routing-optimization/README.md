# Cleaning-crew routing optimization

**Practice:** RC — Retail & Consumer  
**Catalog index:** 016 (compact)  
**Service code:** `RC-E2E-05`  
**Headline KPI:** ↓ −24% labor hours

## Description
Dynamic cleaning-task routing based on traffic patterns and incident history.
