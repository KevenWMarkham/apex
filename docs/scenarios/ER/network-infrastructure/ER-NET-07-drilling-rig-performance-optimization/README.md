# Drilling-rig performance optimization

**Practice:** ER — Energy & Resources  
**Catalog index:** 029 (compact)  
**Service code:** `ER-OG-02`  
**Headline KPI:** ↓ −14% drill-cycle time

## Description
ROP and downhole tool optimization across rig fleet.
