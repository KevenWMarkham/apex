# Buy-online-pickup-in-store orchestration

**Practice:** RC — Retail & Consumer  
**Catalog index:** 012 (compact)  
**Service code:** `RC-E2E-06`  
**Headline KPI:** ↓ −42% wait time

## Description
BOPIS order batching, staging, and customer-communication timing.
