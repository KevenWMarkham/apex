# Direct-contracting performance

**Practice:** HLS — Health, Life Sciences  
**Catalog index:** 036 (compact)  
**Service code:** `HLS-E2E-06`  
**Headline KPI:** ↑ +3.1% cost-of-care reduction

## Description
Direct-contracting performance with intervention analytics.
