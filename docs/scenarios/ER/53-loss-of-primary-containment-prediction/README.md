# Loss-of-primary-containment prediction

**Practice:** ER — Energy & Resources  
**Catalog index:** 053 (compact)  
**Service code:** `ER-OG-03`  
**Headline KPI:** ↓ −34% LOPC events

## Description
LOPC risk-factor scoring with preventive-maintenance targeting.
