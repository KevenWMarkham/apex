# Store-energy-consumption optimization

**Practice:** RC — Retail & Consumer  
**Catalog index:** 096 (compact)  
**Service code:** `RC-E2E-05`  
**Headline KPI:** ↓ −14% energy cost

## Description
HVAC + refrigeration + lighting optimization driven by occupancy and weather.
