# Restroom-maintenance dispatch

**Practice:** RC — Retail & Consumer  
**Catalog index:** 076 (compact)  
**Service code:** `RC-E2E-05`  
**Headline KPI:** ↑ +14pt guest NPS

## Description
Occupancy + feedback-driven cleaning dispatch instead of fixed schedule.
