# Store-cleanliness-compliance scoring

**Practice:** RC — Retail & Consumer  
**Catalog index:** 094 (compact)  
**Service code:** `RC-E2E-05`  
**Headline KPI:** ↑ +11pt guest NPS

## Description
Computer-vision scoring vs cleanliness standard with targeted dispatches.
