# cloud.gcp.bigquery — Google BigQuery adapter
...
Read BigQuery datasets as Silver source for analytics-on-GCP clients.
...
1. Implement `client.py` wrapping the Google BigQuery SDK
2. Provide IaC for adapter-side resources under `iac/`
3. Smoke test against a Google BigQuery sandbox
