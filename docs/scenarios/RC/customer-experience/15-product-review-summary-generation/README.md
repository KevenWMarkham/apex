# Product-review-summary generation

**Practice:** RC — Retail & Consumer  
**Catalog index:** 071 (compact)  
**Service code:** `RC-E2E-04`  
**Headline KPI:** ↑ +8% PDP conversion

## Description
LLM-powered review summarization with sentiment and feature-level breakdown.
