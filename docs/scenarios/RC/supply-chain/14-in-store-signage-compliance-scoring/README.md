# In-store signage compliance scoring

**Practice:** RC — Retail & Consumer  
**Catalog index:** 046 (compact)  
**Service code:** `RC-E2E-05`  
**Headline KPI:** ↑ +18pp compliance

## Description
Computer-vision verification of promotional-signage placement vs plan-o-gram.
