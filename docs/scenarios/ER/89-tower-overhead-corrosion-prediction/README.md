# Tower-overhead-corrosion prediction

**Practice:** ER — Energy & Resources  
**Catalog index:** 089 (compact)  
**Service code:** `ER-OG-05`  
**Headline KPI:** ↑ +14% equipment life

## Description
Corrosion-rate prediction with neutralizer-dosing optimization.
